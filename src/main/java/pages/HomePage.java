...
public class HomePage  {
	...
	// 2nd way to create a WebElement: not common, here I used for the 'password'
		...
		// Web Element: New User Registration Button, cssSelector as locator using class value
	...
	// We used try-catch block to handle exception in this method
		...
		// cssSelector by another attribute
		// --> htmltag.value of class[other attribute name = 'value of the attribute'] , you can use attribute except id and class
		...
		// Not important, can ignore
		// cssSelector by another attribute
		// --> htmltag#value of ID[other attribute name='value of attribute '] , you can use attribute except id and class
		// That's why we use title
