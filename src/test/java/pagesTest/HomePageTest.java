...
public class HomePageTest extends BaseClass {
	...
	// The test executed based on alphabetical order, if no priority given for
	// couple of tests
	...
	// and see the above method skipped as it depends on
	// new_user_registration_button_enabled
	...
	// invocationCount = The invocationcount attribute tells how many times TestNG
	// should run a test method
	...
	// Is the threadPoolSize working? No, because we need multiple thread in
	// multiple device/computer connected
	// may be working as multi threaded, can't see locally with one computer
	// The threadPoolSize attribute tells it to form a thread pool to run the test
	...
	// Below we wrote the code directly in test cases, you will not find any code in
	// HomePage
	// interview question: what are the alternative of click() method
	// but they are not expecting first 2 answer, they are looking for
	// javascriptExecutor
	// alternate of click()
	@Test
	...
	public void alternate_of_click_method_in_loginButtonTest03() throws InterruptedException {
		...
		// Because JavascriptExecutor Interface is instantiated in HomePage Class, js is
		// not working.
		// If you want js to call directly here, you have to instantiate in baseclass.If
		// you do not want instantiate in BaseClass
	...
	// BelowTesting
	@Test
	public void loginButtonDummyTest() {
		homePage.loginButtonDummy();
	}

	@Test
	public void userIdDummyTest() {
		homePage.userIdDummy();
	}

	@Test
	public void newUserRegDummyTest() {
		homePage.newUserRegDummy();
	}

	@Test
	public void clickPasswordElementDummyTest() {
		homePage.clickPasswordElementDummy();
		
	}
	
	@Test
	public void tableAmazonTest() {
		homePage.tableAmazon();
	}
